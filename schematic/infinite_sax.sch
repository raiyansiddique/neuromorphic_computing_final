...
C {madvlsi/gnd.sym} -80 -160 0 0 {name=l4 lab=GND}
C {madvlsi/isource.sym} -80 -190 0 0 {name=I1
value=100n}
C {devices/lab_pin.sym} -80 -220 1 0 {name=p4 sig_type=std_logic lab=IB}
C {devices/lab_pin.sym} 20 -80 3 0 {name=p5 sig_type=std_logic lab=IB}
C {madvlsi/vsource.sym} -10 -190 0 0 {name=Vdd2
value=0}
C {madvlsi/gnd.sym} -10 -160 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} -10 -220 1 0 {name=p6 sig_type=std_logic lab=PHI}
C {devices/lab_pin.sym} 20 -100 1 0 {name=p7 sig_type=std_logic lab=PHI}
C {/home/madvlsi/Documents/second/neuromorphic_computing_final/schematic/mem_sax.sym} -80 -80 0 0 {}
