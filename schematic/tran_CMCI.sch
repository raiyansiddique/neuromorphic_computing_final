...
C {devices/code.sym} 580 90 0 0 {name=SPICE only_toplevel=false value=".param W=12
.param L=0.5
.tran 1ns 10us
.save all
"}
...
C {devices/ammeter.sym} 190 0 3 0 {name=Vmeas}
...
C {devices/lab_pin.sym} 60 -60 1 0 {name=p22 sig_type=std_logic lab=Vbp}
C {/home/madvlsi/neuromorphic_computing_final/schematic/CMCI_synapse_working.sym} 40 0 0 0 {name=X2}
...
C {devices/lab_pin.sym} 10 0 3 0 {name=p11 sig_type=std_logic lab=vtemp}
C {/home/madvlsi/neuromorphic_computing_final/schematic/besrour_neuron_cm.sym} 450 0 0 0 {name=X1}
C {/home/madvlsi/neuromorphic_computing_final/schematic/tg.sym} 260 0 0 0 {name=X4}
C {madvlsi/vdd.sym} 310 -50 0 0 {name=l6 lab=VDD}
